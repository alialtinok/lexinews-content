...
CEFR_LEVELS = [
    CEFRLevel(
        ...
        min_words=60,
        target_words=100,
        description="simple English, common 1000 words, short sentences (8-12 words), basic past and future tenses allowed",
    ),
    CEFRLevel(
        code="B1",
        name="Intermediate",
    ...
    CEFRLevel(
        ...
        min_words=280,
        target_words=380,
        description="native-level English, full vocabulary, complex and varied structures, idiomatic, literary and rhetorical expressions, sophisticated argumentation",
    ),
]
